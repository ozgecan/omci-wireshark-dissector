...
local omci_def = {
	...
	[53] = { me_class_name = "Physical Path Termination Point POTS UNI",
		...
		{ attname="ARC", length=1, setbycreate=false},
		{ attname="ARC interval", length=1, setbycreate=false},
		{ attname="Impedance", length=1, setbyname=false},
	...
	[134] = { me_class_name = "IP Host Config Data",
		...
		{ attname="IP address", length=4, setbycreate=true},
		{ attname="Mask", length=4, setbycreate=true},
		{ attname="Gateway", length=4, setbycreate=true},
		{ attname="Primary DNS", length=4, setbycreate=true},
		{ attname="Secondary DNS", length=4, setbycreate=true},
		...
		{ attname="Domain name", length=25, setbycreate=true},
		{ attname="Host name", length=25,setbycreate=true}
	},

	[141] = { me_class_name= "VoIP line status",
		{ attname="Voip codec used",length=2, setbycreate=true},
		{ attname="Voip voice server status", length=1, setbycreate=true},
		{ attname="Voip port session type", length=1, setbycreate=true},
		{ attname="Voip call 1 packet period", length=2, setbycreate=true},
		{ attname="Voip call 2 packet period", length=2, setbycreate=true},
		{ attname="Voip call 1 dest addr", length=25, setbycreate=true},
		{ attname="Voip call 2 dest addr", length=25, setbycreate=true}
	},
	...
	[329] = { me_class_name = "Virtual Ethernet interface point",
		{ attname="Administrative state", length=2, setbycreate=true },
		{ attname="Operational  state", length=1, setbycreate=false },
		{ attname="Inter-domain name",length=25, setbycreate=false },
		{ attname="TCP/UDP pointer", length=2, setbycreate=false },
		{ attname="IANA assigned port", length=2, setbycreate=true }},

	[332] = { me_class_name = "Enhanced security control",
		{ attname="OLT crypto capabilities", length=16, setbycreate=true},
		{ attname="OLT random challenge table", length=17, setbycreate=true},
		{ attname="OLT challenge status", length=1, setbycreate=true},
		{ attname="ONU selected crypto capabilities", length=1, setbycreate=true},
		{ attname="ONU random challenge table", length=16, setbycreate=true},
		{ attname="ONU authentication result table", length=16, setbycreate=true},
		{ attname="OLT authentication result table", length=17, setbycreate=true},
		{ attname="OLT result status", length=1, setbycreate=true},
		{ attname="ONU authentication state", length=1, setbycreate=true},
		{ attname="Master session key name", length=16, setbycreate=true},
	...
	[334] = { me_class_name = "Ethernet frame extended PM",
		{ attname="Interval end time", length=1, setbycreate=true},
		{ attname="Control block", length=16, setbycreate=true},
		{ attname="Drop events", length=4, setbycreate=true},
		{ attname="Octets", length=4, setbycreate=true},
		{ attname="Frames", length=4, setbycreate=true},
		{ attname="Broadcast frames", length=4, setbycreate=true},
		{ attname="Multicast frames", length=4, setbycreate=true},
		{ attname="CRC errored frames", length=4, setbycreate=true},
		{ attname="Undersize frames", length=4, setbycreate=true},
		{ attname="Oversize frames", length=4, setbycreate=true},
		{ attname="Frames 64 octets", length=4, setbycreate=true},
		{ attname="Frames 65 to 127 octets", length=4,setbycreate=true},
		{ attname="Frames 128 to 255 octets", length=4, setbycreate=true},
		{ attname="Frames 256 to 511 octets", length=4, setbycreate=true},
		{ attname="Frames 512 to 1023 octets", length=4, setbycreate=true},
		{ attname="Frames 1024 to 1518 octets", length=4, setbycreate=true} },

	[336] = { me_class_name = "ONU dynamic power management control",
		{ attname="Power reduction management capability", length=1, setbycreate=true},
		{ attname="Power reduction management mode", length=1, setbycreate=true},
		{ attname="Itransinit", length=2, setbycreate=true},
		{ attname="Itxinit", length=2, setbycreate=true},
		{ attname="Maximum sleep interval", length=4, setbycreate=true},
		{ attname="Minimum aware interval", length=4, setbycreate=true},
		{ attname="Minimum active held interval", length=2, setbycreate=true}},
